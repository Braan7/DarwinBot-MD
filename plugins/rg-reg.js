...
let handler = async (m, { conn, text, args, usedPrefix, command }) => {
    ...
    let channelID = '120363398043363641@newsletter'; // ID del canal donde se enviará la notificación
    let regFormat = /\|?(.*)([.|] *?)([0-9]*)$/i;
    ...
    await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                thumbnailUrl: 'https://qu.ax/bwnww.jpg', // Imagen proporcionada
    ...
    await conn.sendMessage(channelID, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                thumbnailUrl: 'https://qu.ax/rjKnz.jpg', // Imagen proporcionada
                sourceUrl: 'https://your-website.com', // Personaliza con tu enlace
                mediaType: 1,
                renderLargerThumbnail: true
            }
